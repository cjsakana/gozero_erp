...
const (
	...
	User_BulkInsertUser_FullMethodName      = "/pb.user/BulkInsertUser"
	User_UpdateUser_FullMethodName          = "/pb.user/UpdateUser"
	User_GetUserById_FullMethodName         = "/pb.user/GetUserById"
	User_GetUserByEmployeeId_FullMethodName = "/pb.user/GetUserByEmployeeId"
	...
	User_ForgotPassword_FullMethodName      = "/pb.user/ForgotPassword"
)
...
func (c *userClient) BulkInsertUser(ctx context.Context, in *BulkInsertUserReq, opts ...grpc.CallOption) (*BulkInsertUserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BulkInsertUserResp)
	err := c.cc.Invoke(ctx, User_BulkInsertUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserByEmployeeId(ctx context.Context, in *GetUserByEmployeeIdReq, opts ...grpc.CallOption) (*GetUserByEmployeeIdResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserByEmployeeIdResp)
	err := c.cc.Invoke(ctx, User_GetUserByEmployeeId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	BulkInsertUser(context.Context, *BulkInsertUserReq) (*BulkInsertUserResp, error)
	UpdateUser(context.Context, *UpdateUserReq) (*UpdateUserResp, error)
	GetUserById(context.Context, *GetUserByIdReq) (*GetUserByIdResp, error)
	GetUserByEmployeeId(context.Context, *GetUserByEmployeeIdReq) (*GetUserByEmployeeIdResp, error)
...
func (UnimplementedUserServer) BulkInsertUser(context.Context, *BulkInsertUserReq) (*BulkInsertUserResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BulkInsertUser not implemented")
}
...
func (UnimplementedUserServer) GetUserByEmployeeId(context.Context, *GetUserByEmployeeIdReq) (*GetUserByEmployeeIdResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByEmployeeId not implemented")
}
...
func _User_BulkInsertUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkInsertUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).BulkInsertUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_BulkInsertUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).BulkInsertUser(ctx, req.(*BulkInsertUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_GetUserByEmployeeId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserByEmployeeIdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserByEmployeeId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserByEmployeeId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserByEmployeeId(ctx, req.(*GetUserByEmployeeIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BulkInsertUser",
			Handler:    _User_BulkInsertUser_Handler,
		},
		{
		...
		{
			MethodName: "GetUserByEmployeeId",
			Handler:    _User_GetUserByEmployeeId_Handler,
		},
		{
