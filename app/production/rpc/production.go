...
import (
	...
	productionServer "erp/app/production/rpc/internal/server/production"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		production.RegisterProductionServer(grpcServer, productionServer.NewProductionServer(ctx))
